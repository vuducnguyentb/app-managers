							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_category" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo $row['name'] ?>" >Cập Nhật</button>
...
<script>
	...
	$('.delete_category').click(function(){
		_conf("Bạn có chắc chắn muốn xóa loại phòng này?","delete_category",[$(this).attr('data-id')])
	})
