		...
		<div class="card">
			<div class="card-body">
				<div class="col-md-12">
					...
					<div id="report">
						<div class="on-print">
							 <p><center>Báo Cáo Số Nợ Tiền Phòng</center></p>
							 <p><center> <b><?php echo date('F ,Y') ?></b></center></p>
						</div>
						<div class="row">
							<table class="table table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo date('d-m-Y',strtotime($last_payment)) ?></td>
									</tr>
								<?php endwhile; ?>
								<?php else: ?>
									<tr>
